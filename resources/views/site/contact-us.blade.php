        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-12 text-center">
                    <h2 class="display-5 mb-4 mb-md-5 mb-xl-8">We're always on the lookout for all of our clients. Please
                        get in touch in one of the following ways.</h2>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 col-xl-11">
                            <div class="mb-4 mb-md-5">
                                ...
                                <div>
                                    ...
                                    <p class="mb-2">Visit us to have a discussion.</p>
                                    <hr class="w-50 mb-3 border-dark-subtle ml-5">
                                    <address class="m-0 text-secondary">8014 Edith Blvd NE, Albuquerque, New York, United
                                        States</address>
                                </div>
                            </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="mb-4 mb-sm-0">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-2">Speak with us directly.</p>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="mb-4 mb-sm-0">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-2">Write us an email.</p>
                                            <hr class="w-75 mb-3 border-dark-subtle">
                                            <p class="mb-0">
                                                <a class="link-secondary text-decoration-none"
                                                    href="mailto:demo@yourdomain.com">support@yourdomain.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
