                            ...
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div class="product__thumb__pic">
                                        <img src="{{ asset('img/shop-details/thumb-1.png') }}" alt="">
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
                                    <div class="product__thumb__pic">
                                        <img src="{{ asset('img/shop-details/thumb-2.png') }}" alt="">
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
                                    <div class="product__thumb__pic">
                                        <img src="{{ asset('img/shop-details/thumb-3.png') }}" alt="">
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-4" role="tab">
                                    <div class="product__thumb__pic">
                                        <img src="{{ asset('img/shop-details/thumb-4.png') }}" alt="">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <h3>${{ $product->on_sale ? $product->sale_price : $product->price }} @if ($product->on_sale)
